...
<main class="page">
	<header class="hero">
		<a class="back" href="/">← Kembali ke Elmozza</a>
	...
	<section class="notice"><b>Status preview internal.</b> Progress pada versi ini hanya tersimpan selama halaman terbuka. Login, database progress, panel admin, dan publikasi konten akan ditambahkan pada tahap berikutnya.</section>
</main>

<style>
	:global(*) { box-sizing: border-box; }
	:global(body) { margin: 0; background: #f4f7fb; color: #1d2a3a; font-family: Inter, ui-sans-serif, system-ui, sans-serif; }
	.page { max-width: 1240px; margin: 0 auto; padding: 28px 20px 50px; }
	...
	.back { color:#d8f4ef; text-decoration:none; font-weight:700; font-size:.9rem; }
